...
/* synthesis syn_black_box black_box_pad_pin="CLK,CE,SCLR,XN_RE[7:0],XN_IM[7:0],FD_IN,FWD_INV,SIZE[5:0],RFFD,XK_RE[7:0],XK_IM[7:0],BLK_EXP[3:0],FD_OUT,DATA_VALID" */;
  input CLK;
  input CE;
  input SCLR;
  input [7:0]XN_RE;
