...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN T22 [get_ports {f}];  # "LD0"
...
# VGA Output - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y21  [get_ports {RGB[2]}];  # "VGA-B1"
...
set_property PACKAGE_PIN AB22 [get_ports {RGB[1]}];  # "VGA-G1"
...
set_property PACKAGE_PIN V20  [get_ports {RGB[0]}];  # "VGA-R1"
...
## ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN F22 [get_ports {R_switch}];  # "SW0"
#set_property PACKAGE_PIN G22 [get_ports {G_switch}];  # "SW1"
#set_property PACKAGE_PIN H22 [get_ports {B_switch}];  # "SW2"
#set_property PACKAGE_PIN F21 [get_ports {w2}];  # "SW3"
#set_property PACKAGE_PIN H19 [get_ports {w3}];  # "SW4"
#set_property PACKAGE_PIN H18 [get_ports {w4}];  # "SW5"
