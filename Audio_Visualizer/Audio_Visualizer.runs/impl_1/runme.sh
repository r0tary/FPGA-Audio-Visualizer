...
HD_PWD='C:/Users/games/OneDrive/Dokumenter/GitHub/FPGA-Audio-Visualizer/Audio_Visualizer/Audio_Visualizer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Visualizer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Visualizer.tcl -notrace
