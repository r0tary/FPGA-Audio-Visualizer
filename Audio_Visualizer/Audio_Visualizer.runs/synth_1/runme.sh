...
HD_PWD='C:/Users/games/OneDrive/Dokumenter/GitHub/FPGA-Audio-Visualizer/Audio_Visualizer/Audio_Visualizer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Visualizer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Visualizer.tcl
